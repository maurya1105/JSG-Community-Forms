...
const FormADataTable = () => {
  ...
  const columns = [
    { data: "groupNo", title: "Group Number", width: "20%" },
    { data: "region", title: "Region", width: "40%" },
    { data: "groupName", title: "Group Name", width: "20%" },
    {
      data: "dateOfInaugration",
  ...
  return (
    <div className="datatable-container">
      <h1 className="datatable-title">Form B Data</h1>
      <button onClick={() => navigate("/form-b")} className="new-form-button">
        + New Form
      </button>
      <DataTable
        data={data}
